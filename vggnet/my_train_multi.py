...
def main(args):
    ...
    with graph.as_default(), tf.device('/cpu:0'):
        ...
        boundaries = [20*nu_epoch, 30*nu_epoch, 40*nu_epoch, 50*nu_epoch, 55*nu_epoch, 60*nu_epoch, 65*nu_epoch, 70*nu_epoch, 75*nu_epoch]
        init_lr = 0.005
        values=[init_lr, init_lr*0.75, init_lr*0.5, init_lr*0.25, init_lr*0.125, init_lr*(0.125*0.9), init_lr*(0.125*0.81), init_lr*(0.125*0.729), init_lr*(0.125*0.6561), init_lr*(0.125*0.59049)]
        #init_lr = 0.002
