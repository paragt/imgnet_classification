...
if __name__ == '__main__':
    ...
    with tf.Session(graph=graph) as sess:
        ## run with CUDA_VISIBLE_DEVICES=4,5,6,7 
        new_saver = tf.train.import_meta_graph('/trn_dir/models/model_multi_cl20_preprocess/model-000034.meta')
        new_saver.restore(sess, '/trn_dir/models/model_multi_cl20_preprocess/model-000034')
