...
def main(args):
    ...
    with graph.as_default():
        ...
        dataldr_val=mydataloader_val(args.val_dir)
        ...
        with slim.arg_scope(vgg.vgg_arg_scope(weight_decay=args.weight_decay)):
            logits, endpoints_dict = vgg.vgg_16(images, num_classes=dataldr_trn.num_classes, is_training=is_training,dropout_keep_prob=args.dropout_keep_prob)
        ...
        for epoch in range(args.num_epochs2):
            ...
            while True:
                try:
                    ...
                    #fc8_output = sess.run(tf.contrib.framework.get_variables('vgg_16_end_points/fc8:0'))
            ...
            #pred = sess.run(tf.get_collection()) 
