...
def main(args):
    ...
    with graph.as_default(), tf.device('/cpu:0'):
        ...
        prediction = tf.to_int32(tf.argmax(logits_array, 1))-1
    ...
    with tf.Session(graph=graph) as sess:
        ...
        val_acc = check_accuracy(sess, correct_prediction, image_names, labels, train_mode, args.val_dir, args.label_map,prediction, logits_array)
